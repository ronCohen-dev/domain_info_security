const parseVirusesTotal = function (virusTotalInfo) {
    const virusData = {
        ...
        lastHttpsCertificateDate: new Date(virusTotalInfo.data.attributes.last_https_certificate_date * 1000).toISOString(),
...
const parseWhoIsInfo = function (whoisInfo) {
    const whoami = {
        domainName: whoisInfo.WhoisRecord.domainName, // Use the correct variable name        parseCode: parsedData.parseCode,
...
module.exports = {parseVirusesTotal, parseWhoIsInfo};